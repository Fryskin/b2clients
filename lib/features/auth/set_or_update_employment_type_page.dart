...
class SetOrUpdateEmploymentTypePage extends StatefulWidget {
  const SetOrUpdateEmploymentTypePage({super.key});

  @override
  State<SetOrUpdateEmploymentTypePage> createState() =>
      _SetOrUpdateEmploymentTypePageState();
}

class _SetOrUpdateEmploymentTypePageState
    extends State<SetOrUpdateEmploymentTypePage> {
